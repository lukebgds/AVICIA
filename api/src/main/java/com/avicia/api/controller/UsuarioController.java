...
public class UsuarioController {
    ...
    @DeleteMapping("/{cpf}") // localhost:9081/api/usuarios/{cpf}
    public ResponseEntity<Void> deletar(@PathVariable Integer isUsuario) {

        boolean deletado = usuarioService.deletar(isUsuario);
